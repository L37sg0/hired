                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="bd-example">
                            ...
                            <span class="badge text-bg-secondary">Wordpress</span>
                            <span class="badge text-bg-success">Nginx</span>
                            ...
                            <span class="badge text-bg-dark">Linux</span>
                        </div>
                        <p class="card-text text-dark">I need somebody to create me a portfolio website.</p>
